...
namespace APIVerve
{
    public class MoonPhasesAPIClient
    {
        ...
        public MoonPhasesAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }

        public MoonPhasesAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public ResponseObj Execute(moonphasesQueryOptions options)
        {
            try
            {
                if (_isDebug)
